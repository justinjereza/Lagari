...
//    private static final Vector<BlockFace> blockFaces = new Vector<BlockFace>(Arrays.asList(BlockFace.values()));
...
//        logger.info("LEAF NOT IN LOG RANGE");
        return r;
    }
    ...
    private LinkedList<Block> getNeighborBlocks(Block block) {
        ...
        for (BlockFace face : blockFaces) {
            ...
            case CLASSIC:
                if (logList.contains(m)) {
                    r.add(b);
//                    logger.info("CLASSIC Added neighbor: " + face + " Type: " + m);
//                } else {
//                    logger.info("CLASSIC " + face + " neighbor type: " + m);
                }
                break;
            case CLASSIC_LEAVES:
                if (logList.contains(m)) {
...
//                    logger.info("CLASSIC_LEAVES " + face + " neighbor type: " + m);
            ...
            case FULL:
                if (logList.contains(m) || leafList.contains(m)) {
                    r.add(b);
//                    logger.info("FULL Added neighbor: " + face + " Type: " + m);
//                } else {
//                    logger.info("FULL " + face + " neighbor type: " + m);
                }
            }
        }
        logger.info("-----");
